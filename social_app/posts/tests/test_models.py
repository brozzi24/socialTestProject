...
class TestModels(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # Comment
        cls.user2 = User.objects.create_user(username='testuser24',password='justatest24')
    ...
    def test_post(self):
        ...
        self.assertEquals(self.post1.text,'What are your thoughts on baby yoda? #TheMandalorian')
